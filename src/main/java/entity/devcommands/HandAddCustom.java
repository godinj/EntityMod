...
public class HandAddCustom extends ConsoleCommand {
    public HandAddCustom() {
        requiresPlayer = true;
        minExtraTokens = 1;
        maxExtraTokens = 3;
    }
    ...
    public ArrayList<String> extraOptions(String[] tokens, int depth) {
        ArrayList<String> options = ConsoleCommand.getCardOptions("FROM MYSELF??");
